...
on('gameStop', function () {
  datas = createLeaveData([12,3,config.types.bmob.children.scattering],[12,3,config.types.bmob.children.scattering],[12,3,config.types.bmob.children.scattering])
});
